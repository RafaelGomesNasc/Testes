...
class AssistenteEnsino(Funcionario, Estudante):
    def __init__(self, nome, matricula = 0, cursoFrequentado = '', salario = 0, cursoSelecionado = ''):
        Professor.__init__(self, salario = salario, cursoLecionado = cursoSelecionado)
        Aluno.__init__(self, matricula = matricula, cursoFrequentado = cursoFrequentado)
        Pessoa.__init__(self, nome)
