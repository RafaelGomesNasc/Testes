...
class AssistenteEnsino(Funcionario, Estudante):
    ...
    def __init__(self, nome="", cursoFrequentado="", salario=0, cursoLecionado=""):
        Pessoa.__init__(self, nome)
    ...
    def definirMatricula(self, matricula):
        self.matricula = matricula

    def __str__(self):
        return f"Nome: {self.nome}, Id: {self.id}, Matrícula: {self.matricula}, Curso: {self.curso}, Salário: {self.salario}"
...
if __name__ == "__main__":
    ...
    # --------------------------------#
    try:
        assistente = AssistenteEnsino("Marta", "Computação", 1500, "Física")
        assistente2 = AssistenteEnsino("Paulo", "Engenharia", 1800, "Química")
        assistente.definirMatricula(8765)
        assistente2.definirMatricula(5432)
        assistente.definirSalario(2000)
        assistente2.definirSalario(2500)
        assistente.definirCursoSelecionado("Matemática")
        assistente2.definirCursoSelecionado("Biologia")
        assistente.definirCursoFrequentado("Computação")
        assistente2.definirCursoFrequentado("Engenharia")
        print(assistente)
        print(assistente2)
    except Exception as e:
        print(e)
